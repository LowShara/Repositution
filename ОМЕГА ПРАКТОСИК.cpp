...
int main()
{
    ...
    cout << "Сумма чисел от 1 до Z: " << sus(z) << endl;
}
...
int main() {
    ...
    cout << "Введите число azov: " << endl;
    cin >> azov;
    cout << factorn(azov) << endl;
}
...
int main()
{
    ...
    cout << "Введите число soska: ";
    cin >> soska;
    int result = summachisel(sos);

    cout << "сумма цифр числа soska = " << result;
}
...
int main() {
    ...
    cout << "Наибольший общий делитель" << xa << " " << xb << " = " << nuds << endl;
}
...
int main() {
    ...
    cout << "Сумма чисел фибоначи: " << summafib(gigity) << endl;
}
